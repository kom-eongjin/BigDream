...
btn_test.addEventListener('click', function(e){ alert('오늘 보이지 않던 희망이 내일은 보일거야  **   그렇게 난 희망찬 내일을 다짐했지만...');});
...
btn_test3.addEventListener('click', function(e){ alert('내 앞길은 내가 알아서 ! 알아서 척척 스스로 척척 !');});
...
btn_test5.addEventListener('click', function(e){ alert('내 앞길은 내가 알아서 ! 알아서 척척 스스로 척척 !');});
...
btn_test8.addEventListener('click', function(e){ alert('내가판우물은 무수히 많은데.. 물이 나오려면 한참 멀은거지?');});
